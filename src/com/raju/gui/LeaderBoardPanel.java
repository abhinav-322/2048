...
import com.raju.game.ClassicLeaderboards;
...
public class LeaderBoardPanel extends GuiPanel {
    ...
    private ClassicLeaderboards clBoard;
    ...
    public LeaderBoardPanel(){
        ...
        lBoard.loadScores();
        clBoard = ClassicLeaderboards.getInstance();
        clBoard.loadClassicScores();
...
//        add(tileButton);
        ...
        GuiButton scoreButton = new GuiButton(Game.WIDTH / 2 - buttonWidth / 2, buttonY, buttonWidth, buttonHeight);
    ...
    private void drawLeaderboards(Graphics2D g){
        ...
        if(currentState == State.SCORE){
            strings = convertToStrings(clBoard.getClassictopScores());
        }
